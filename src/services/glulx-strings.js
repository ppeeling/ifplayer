...
(function() {
  ...
  exports.extract_glulx_strings = function(bytes, cb) {
    ...
    assert = function(cond) { if (!cond) throw new Error('assert failed'); };
...
export const is_glulx = exports.is_glulx;
export const extract_glulx_strings = exports.extract_glulx_strings;
export const is_zcode = exports.is_zcode;
export const extract_zcode_strings = exports.extract_zcode_strings;
export const is_blorb = exports.is_blorb;
export const unblorb = exports.unblorb;
export const is_t3 = exports.is_t3;
export const extract_t3_strings = exports.extract_t3_strings;
export const is_tads2 = exports.is_tads2;
export const extract_tads2_strings = exports.extract_tads2_strings;
export const unbase64 = exports.unbase64;
export const extract_strings = exports.extract_strings;
